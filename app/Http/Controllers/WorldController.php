    ...
    */
    ...
    public function getFeatures(Request $request) {
        ...
        return view('world.features', [
            ...
            'specieses'  => ['none' => 'Any '.ucfirst(__('lorekeeper.species'))] + ['withoutOption' => 'Without '.ucfirst(__('lorekeeper.species'))] + Species::visible(Auth::check() ? Auth::user() : null)->orderBy('sort', 'DESC')->pluck('name', 'id')->toArray(),
            'subtypes'   => ['none' => 'Any '.ucfirst(__('lorekeeper.subtype'))] + ['withoutOption' => 'Without '.ucfirst(__('lorekeeper.subtype'))] + Subtype::visible(Auth::check() ? Auth::user() : null)->orderBy('sort', 'DESC')->pluck('name', 'id')->toArray(),
