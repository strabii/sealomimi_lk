...
class BrowseController extends Controller {
    ...
    */
    ...
    public function getCharacters(Request $request) {
        ...
        if ($request->get(__('lorekeeper.subtype').'_id')) {
            $imageQuery->where('subtype_id', $request->get(__('lorekeeper.subtype').'_id'));
        }
    ...
    public function getMyos(Request $request) {
         ...
         * }
         *
         * $categories = CharacterCategory::pluck('name', 'id')->toArray();
         */
        ...
        return view('browse.myo_masterlist', [
            ...
            'specieses'   => [0 => 'Any '.ucfirst(__('lorekeeper.species'))] + Species::visible(Auth::check() ? Auth::user() : null)->orderBy('specieses.sort', 'DESC')->pluck('name', 'id')->toArray(),
            'rarities'    => [0 => 'Any Rarity'] + Rarity::orderBy('rarities.sort', 'DESC')->pluck('name', 'id')->toArray(),
