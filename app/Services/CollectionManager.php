    ...
    public function completeCollection($data, $collection, $user) {
        ...
        try {
            ...
            if ($collection->parent_id) {
                ...
                if (!$completed) {
                    throw new \Exception('Please complete the prerequisite first.');
                }
            }
            ...
            if (!fillUserAssets($collection->rewardItems, null, $user, $logType, $collectionData)) {
            ...
            if (!$servicetwo->creditCollection(null, $user, null, $logTypetwo, $collectionDatatwo, $collection)) {
