    ...
    */
    ...
    public function createTheme($data, $user)
    {
        ...
        try {
            ...
            $data['headerdoll_image_url'] = (isset($data['headerdoll_image_url'])) ? $data['headerdoll_image_url'] : '';
            $data['pagedoll_image_url'] = (isset($data['pagedoll_image_url'])) ? $data['pagedoll_image_url'] : '';
