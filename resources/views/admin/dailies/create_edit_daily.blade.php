...
{!! Form::close() !!}
@include('dailies._loot_select_row', ['items' => $items, 'currencies' => $currencies, 'awards' => $awards, 'tables' => $tables, 'raffles' => $raffles, 'showLootTables' => true, 'showRaffles' => true, 'showThemes' => true])
