                        ...
                        <tbody class="character-rewards">
                            @foreach ($character->rewards ?? [] as $reward)
                                <tr class="character-reward-row">
                                    @if ($expanded_rewards)
                                        <td>
                                            {!! Form::select('character_rewardable_type[' . $character->character_id . '][]', ['Item' => 'Item', 'Currency' => 'Currency', 'Pet' => 'Pet', 'LootTable' => 'Loot Table', 'Award' => ucfirst(__('awards.award')), 'Exp' => 'Exp', 'Points' => 'Stat Points', 'Element' => 'Element'], $reward->rewardable_type, [
                                        ...
                                        <td class="lootDivs">
                                            ...
                                            <div class="character-pets  {{ $reward->rewardable_type == 'Pet' ? 'show' : 'hide' }}">{!! Form::select('character_rewardable_id[' . $character->character_id . '][]', $pets, $reward->rewardable_type == 'Pet' ? $reward->rewardable_id : null, ['class' => 'form-control character-pet-id', 'placeholder' => 'Select Pet']) !!}</div>
                                            <div class="character-awards  {{ $reward->rewardable_type == 'Award' ? 'show' : 'hide'}}">{!! Form::select('character_rewardable_id['.$character->character_id.'][]', $awards, ($reward->rewardable_type == 'Award' ? $reward->rewardable_id : null) , ['class' => 'form-control character-award-id', 'placeholder' => 'Select '.ucfirst(__('awards.award'))]) !!}</div>
